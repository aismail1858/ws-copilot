      ...
      {isAdmin && (
        <button
          ...
          className={
            ...
            (isSettingsActive ? "bg-[#fff1e8] text-[#2f2b26]" : "text-[#756b62] hover:bg-[#2f2b26]/[0.04] hover:text-[#2f2b26]")
          }
        >
          <SettingsIcon />
          ...
          <div className="flex items-center gap-x-3 text-[#756b62] group-hover:text-[#2f2b26] transition-colors">
            ...
            <div className="flex flex-col overflow-hidden w-24 sm:w-28">
              <span className="truncate text-sm font-medium text-[#2f2b26]">
                {user?.display_name || user?.email || "Admin Profil"}
              </span>
        ...
        {isUserMenuOpen && (
          <div className="absolute bottom-full left-0 right-0 mb-2 overflow-hidden rounded-xl border border-[#2f2b26]/10 bg-white shadow-[0_4px_16px_rgba(47,43,38,0.08),0_16px_48px_rgba(47,43,38,0.1)]">
            <button
              ...
              className="flex items-center gap-x-3 w-full px-3 py-2 text-sm text-[#756b62] hover:bg-[#2f2b26]/[0.04] hover:text-[#2f2b26] transition-colors"
            >
              <SettingsIcon />
            ...
            <button
              ...
              className="flex items-center gap-x-3 w-full px-3 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors"
            >
              <LogoutIcon />
              <span>Abmelden</span>
            </button>
